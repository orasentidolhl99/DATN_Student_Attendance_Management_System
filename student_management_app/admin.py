...
from student_management_app.models import (
    CustomUser, AdminHOD, Teachers, Courses,
    Subjects, Students, Attendance, AttendanceReport,
    LeaveReportStudent, LeaveReportTeacher,
    FeedBackStudent, FeedBackTeacher, NotificationStudent,
    NotificationTeacher, StudentSubjectLink, PostImageStudent
)
...
admin.site.register(PostImageStudent)
